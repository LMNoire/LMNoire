...
- 🌱 Titulaire d'une formation certifiante de développeur Fullstack orientée vers PHP/Symfony, la stack MERN ou encore les API le tout avec une approche micro-services, n'hésitez pas à consulter mon repository MS-Dev-2024 (https://github.com/LMNoire/MS-Dev-2024) pour plus d'informations sur les compétences et outils abordés durant cette formation ! 
